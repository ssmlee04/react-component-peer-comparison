...
class TagBarCharts extends React.Component {
  render() {
    const { data, name, color, tickercolor, height = 80, ticker, sector = 'Sector' } = this.props;
    if ( !data ) {
      return (
    ...
    return (
      <div className='row no-gutters font-10'>
        <div className='col-md-12' key={name}>
          <span className='font-12 darkred bold'>{sector} - <span style={{ color: 'green' }}>{name}</span></span>
